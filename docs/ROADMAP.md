...
- Next: add repeatable weakened-target acquisition plus corpse acquisition, delivery/report-item policy, one kill objective, one talk/emote objective, and one travel objective as separately measured slices.
