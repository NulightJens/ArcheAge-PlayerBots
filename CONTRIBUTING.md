...
1. Install the module in a clean compatible AAEmu checkout as described in `docs/INSTALLATION.md`.
...
Do not commit credentials, raw player data, server databases, client assets, recordings, runtime logs, or generated evidence. Read `docs/DEVELOPMENT.md` and `docs/TESTING.md` for the full review and evidence checklist.
