...
/// <summary>Runs supported quests through AAEmu's native combat, loot, and report paths.</summary>
public sealed class BotQuestLifecycleController
{
    ...
    // Quest chains may report beyond the 500 m local-work radius.
    ...
    /// <summary>Returns true while a supported quest owns this tick.</summary>
    internal bool Step(BotRuntime runtime, BotConfig config, DateTimeOffset now)
    {
        ...
        lock (_syncRoot)
        {
            ...
            // Release an intake route before active quest work claims movement.
            ...
            // Hold priority for one tick while movement cancellation settles.
            if (releasedIntake)
            {
        ...
        DateTimeOffset now)
    {
        ...
        if (reportObject.Distance > config.QuestReportInteractionRadius)
        {
            ...
            // Keep the accepted route stable until ownership changes.
            if (!_ownedDestination.HasValue || CurrentRequestedDestination(runtime) == null)
            {
        ...
        DateTimeOffset now)
    {
        ...
        // Keep valid current work to prevent route thrashing.
        ...
        return eligible
            ...
            // Clear nearby work before a regional handoff.
        ...
        DateTimeOffset now)
    {
        ...
        {
            // Normal quest guards still validate the selected work.
            return float.PositiveInfinity;
        }
    }
